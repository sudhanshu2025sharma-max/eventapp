...
Task:
This is my detailed prompt now i want to make the major and important part of this which is role based access, which required seeding the user and their information so that any participant can contact them, Here are the html which i extracted form the website we only and only concern with name, designation, contact info and photos extra info:
Dr. Nabi Hasan
Organising Chair, ETD-2026 | Librarian & Head, IIT Delhi
Dr. Neeraj Chaurasia
Organizing Secretary, ETD-2026 | Deputy Librarian, IIT Delhi

Important things,
Admin assign task to these persons suppose, admin assigned person a to registration then if they logged in with their id and password then in the admin section they only get check in option none other option are visible to them
Same cases for other, admin can assign more than one task to the person, 
After feeding they get their login id and password, and if nothing is assigned then they see nothing at admin screen, Same they can access their responsibility via web and app as well This is the crucial part,
For the communication between them they also can communicate like other participants and they also can make calls via WebRTC They can make calls among themselves only, There will be a common group for discussion and the staff is also reachable to the participants they can communicate them via chat.
These are the major feature i have mentioned we can add more to facilitate the smooth functioning.
Make sure admin can add more staff if required so 
Link the This staff team in the quick access schedule link, match the order 
Also donwnload and keep the photos in our server 
libbrarina:
<div class="featured-cards"><article class="featured-card animate-in" data-name="dr. nabi hasan" data-designation="librarian &amp; head" style="transform: translateY(0px); transition: opacity 0.4s, transform 0.4s; opacity: 1;"><div class="fc-photo"><img src="/media/team/photos/pic.jpg" alt="Dr. Nabi Hasan" loading="lazy"></div><div class="fc-info"><h3>Dr. Nabi Hasan</h3><p class="fc-designation">Librarian &amp; Head</p><p class="fc-department"><i class="bi bi-building"></i> Central Library, IIT Delhi </p><div class="fc-contacts"><a href="tel:+91-11-26591451" class="fc-contact-item" title="Call"><i class="bi bi-telephone-fill"></i> +91-11-26591451 </a><a href="mailto:hodlibrary@admin.iitd.ac.in" class="fc-contact-item" title="Email"><i class="bi bi-envelope-fill"></i> hodlibrary@admin.iitd.ac.in </a><span class="fc-contact-item" title="Location"><i class="bi bi-geo-alt-fill"></i> Central Library, IIT Delhi, Hauz … </span></div><div class="fc-actions"><a href="/staff/member/dr-nabi-hasan/profile/" class="fc-detailed-btn"><i class="bi bi-file-person-fill"></i> Academic Profile <i class="bi bi-arrow-right"></i></a><a href="http://web.iitd.ac.in/~hasan/" target="_blank" class="fc-profile-btn"><i class="bi bi-person-lines-fill"></i> View Full Profile <i class="bi bi-arrow-right"></i></a><a href="https://www.linkedin.com/in/nabihasaniit" target="_blank" class="fc-social-btn" title="LinkedIn"><i class="bi bi-linkedin"></i></a><a href="https://scholar.google.co.in/citations?user=-nPiCskAAAAJ" target="_blank" class="fc-social-btn" title="Google Scholar"><i class="bi bi-mortarboard-fill"></i></a></div></div></article></div>

Officers:
<div class="officer-cards"><article class="officer-card animate-in" data-name="dr. neeraj kumar chaurasia" data-designation="deputy librarian" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/neeraj.jpg" alt="Dr. Neeraj Kumar Chaurasia" loading="lazy"></div><div class="oc-basic"><h4>Dr. Neeraj Kumar Chaurasia</h4><span class="oc-badge">Deputy Librarian</span></div></div><div class="oc-responsibilities" style="display:none;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">General Administration (GA)</span><span class="resp-tag">Collection Development Division (CDD)</span><span class="resp-tag">Library Store &amp; Purchase Section (LSP)</span><span class="resp-tag">Stock Verification (SV)</span><span class="resp-tag">Data Validation (DV)</span><span class="resp-tag">Coordinator: Library Literary &amp; Cultural Club (LLCC)</span><span class="resp-tag">Head - Hindi Cell</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26596622" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26596622 </a><a href="mailto:neerajkc@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> neerajkc@library.iitd… </a></div><a href="/staff/member/dr-neeraj-kumar-chaurasia/profile/" class="oc-detailed-btn" title="View Academic Profile"><i class="bi bi-file-person-fill"></i></a><a href="https://lib.iitd.ac.in/Neeraj-Kumar-Chaurasia" target="_blank" class="oc-profile-btn" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div><button type="button" class="oc-show-more-btn" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show More</span></button></article><article class="officer-card animate-in" data-name="dr. shankar b. chavan" data-designation="deputy librarian" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/sbc.jpg" alt="Dr. Shankar B. Chavan" loading="lazy"></div><div class="oc-basic"><h4>Dr. Shankar B. Chavan</h4><span class="oc-badge">Deputy Librarian</span></div></div><div class="oc-responsibilities" style="display:none;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">Reader Services Division (RSD)</span><span class="resp-tag">Data Support Services (DSS)</span><span class="resp-tag">Nodal Officer: IRINS Faculty Profiling System</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26591445" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26591445 </a><a href="mailto:shankar.chavan@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> shankar.chavan@librar… </a></div><a href="http://web.iitd.ernet.in/~shankar.chavan/" target="_blank" class="oc-profile-btn" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div><button type="button" class="oc-show-more-btn" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show More</span></button></article><article class="officer-card animate-in" data-name="dr. vijay kumar verma" data-designation="assistant librarian (sg)" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/vijay_verma.jpg" alt="Dr. Vijay Kumar Verma" loading="lazy"></div><div class="oc-basic"><h4>Dr. Vijay Kumar Verma</h4><span class="oc-badge">Assistant Librarian (SG)</span></div></div><div class="oc-responsibilities" style="display: block;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">E-Resources Division (ERD)</span><span class="resp-tag">Research Support Services and Outreach Programs (RSS)</span><span class="resp-tag">Nodal Officer-Hindi Section (Central Library)</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26596631" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26596631 </a><a href="mailto:vkverma@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> vkverma@library.iitd.… </a></div><a href="/staff/member/dr-vijay-kumar-verma/profile/" class="oc-detailed-btn" title="View Academic Profile"><i class="bi bi-file-person-fill"></i></a><a href="https://web.iitd.ac.in/~vkverma/" target="_blank" class="oc-profile-btn" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div><button type="button" class="oc-show-more-btn active" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show Less</span></button></article><article class="officer-card animate-in" data-name="dr. vanita khanchandani" data-designation="assistant librarian (sg)" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/8802925841.JPG" alt="Dr. Vanita Khanchandani" loading="lazy"></div><div class="oc-basic"><h4>Dr. Vanita Khanchandani</h4><span class="oc-badge">Assistant Librarian (SG)</span></div></div><div class="oc-responsibilities" style="display: block;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">Internship &amp; Stack Management Coordinator (ISMC)</span><span class="resp-tag">Text-Book &amp; Book Bank Section (TBB)</span><span class="resp-tag">Humanities &amp; Social Sciences Section (HSS)</span><span class="resp-tag">Theses Section</span><span class="resp-tag">Binding Section</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26591496/6654" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26591496/6654 </a><a href="mailto:vanita@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> vanita@library.iitd.a… </a></div><a href="/staff/member/dr-vanita-khanchandani/profile/" class="oc-detailed-btn" title="View Academic Profile"><i class="bi bi-file-person-fill"></i></a></div><button type="button" class="oc-show-more-btn active" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show Less</span></button></article><article class="officer-card animate-in" data-name="dr. mohit garg" data-designation="assistant librarian (ss)" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/mohit.png" alt="Dr. Mohit Garg" loading="lazy"></div><div class="oc-basic"><h4>Dr. Mohit Garg</h4><span class="oc-badge">Assistant Librarian (SS)</span></div></div><div class="oc-responsibilities" style="display:none;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">Computer Applications Division (CAD)</span><span class="resp-tag">Human Resources Development Division (HRDD)</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26591467" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26591467 </a><a href="mailto:gargmohit@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> gargmohit@library.iit… </a></div><a href="/staff/member/dr-mohit-garg/profile/" class="oc-detailed-btn" title="View Academic Profile"><i class="bi bi-file-person-fill"></i></a><a href="https://web.iitd.ac.in/~gargmohit/" target="_blank" class="oc-profile-btn" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div><button type="button" class="oc-show-more-btn" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show More</span></button></article><article class="officer-card animate-in" data-name="dr. manu t r" data-designation="assistant librarian (ss)" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/IMG_0735.JPG" alt="Dr. Manu T R" loading="lazy"></div><div class="oc-basic"><h4>Dr. Manu T R</h4><span class="oc-badge">Assistant Librarian (SS)</span></div></div><div class="oc-responsibilities" style="display:none;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">Collection Development Division</span><span class="resp-tag">IITD Central Library-interns Alumni Network (CLAN)</span><span class="resp-tag">Coordinator - Unit Libraries' Collection Management</span><span class="resp-tag">Professional Support to the Office of the Librarian</span><span class="resp-tag">Coordinator: Monthly Meetings</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26596096" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26596096 </a><a href="mailto:manutr@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> manutr@library.iitd.a… </a></div><a href="/staff/member/dr-manu-t-r/profile/" class="oc-detailed-btn" title="View Academic Profile"><i class="bi bi-file-person-fill"></i></a><a href="https://web.iitd.ac.in/~manutr/" target="_blank" class="oc-profile-btn" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div><button type="button" class="oc-show-more-btn" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show More</span></button></article><article class="officer-card animate-in" data-name="mr. satbir chauhan" data-designation="assistant librarian" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="oc-header"><div class="oc-photo"><img src="/media/team/photos/satbir.png" alt="Mr. Satbir Chauhan" loading="lazy"></div><div class="oc-basic"><h4>Mr. Satbir Chauhan</h4><span class="oc-badge">Assistant Librarian</span></div></div><div class="oc-responsibilities" style="display:none;"><div class="oc-resp-title"><i class="bi bi-list-check"></i> Key Responsibilities </div><div class="oc-resp-tags"><span class="resp-tag">Research Support Services and Outreach Programs (RSS)</span><span class="resp-tag">New and Innovative Library Services</span><span class="resp-tag">Professional Support to the Office of the Librarian</span></div></div><div class="oc-footer"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><div class="oc-contact-list"><a href="tel:+91-11-26596876" class="oc-contact-chip" title="Call"><i class="bi bi-telephone"></i> +91-11-26596876 </a><a href="mailto:satbir@library.iitd.ac.in" class="oc-contact-chip" title="Email"><i class="bi bi-envelope"></i> satbir@library.iitd.a… </a></div></div><button type="button" class="oc-show-more-btn" onclick="toggleResp(this)"><i class="bi bi-chevron-down"></i><span>Show More</span></button></article></div>

Staff:
<div class="member-grid"><article class="member-card animate-in" data-name="ms. gunjan mishra" data-designation="library information officer" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/gunjanmi.jpg" alt="Ms. Gunjan Mishra" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Ms. Gunjan Mishra </h5><p class="mc-designation">Library Information Officer</p><p class="mc-section"><i class="bi bi-building"></i> Electronic Resources Division </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> ERD </span><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> RSS </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>gunjan0605@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596627</span></div><div class="mc-actions"></div></article><article class="member-card animate-in" data-name="mr. nizam husain" data-designation="sr. library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/NizamHusain.jpg" alt="Mr. Nizam Husain" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mr. Nizam Husain </h5><p class="mc-designation">Sr. Library Information Assistant</p><p class="mc-section"><i class="bi bi-building"></i> Collection Development Division </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> CDD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>nizam@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596652</span></div><div class="mc-actions"></div></article><article class="member-card animate-in" data-name="mr. rahul kumar napit" data-designation="sr. library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/rahulnapit.jpeg" alt="Mr. Rahul Kumar Napit" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mr. Rahul Kumar Napit </h5><p class="mc-designation">Sr. Library Information Assistant</p><p class="mc-section"><i class="bi bi-building"></i> Collection Development Division </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> CDD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>napitrahul@iitd.ac.in</span></div><div class="mc-actions"></div></article><article class="member-card animate-in" data-name="ms. charu" data-designation="sr. library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/charu.jpg" alt="Ms. Charu" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Ms. Charu </h5><p class="mc-designation">Sr. Library Information Assistant</p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> CDD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>charu@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596652</span></div><div class="mc-actions"><a href="https://www.linkedin.com/in/charu-verma-12296a171" target="_blank" title="LinkedIn"><i class="bi bi-linkedin"></i></a></div></article><article class="member-card animate-in" data-name="mrs. ratna das" data-designation="sr. library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/ratna.jpg" alt="Mrs. Ratna Das" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mrs. Ratna Das </h5><p class="mc-designation">Sr. Library Information Assistant</p><p class="mc-section"><i class="bi bi-building"></i> Reader Services Division </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> RSD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>ratnad@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26597017</span></div><div class="mc-actions"><a href="https://www.linkedin.com/in/ratna-das-260371190" target="_blank" title="LinkedIn"><i class="bi bi-linkedin"></i></a></div></article><article class="member-card animate-in" data-name="mr. b. kranthi kumar" data-designation="library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/BK.jpg" alt="Mr. B. Kranthi Kumar" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mr. B. Kranthi Kumar </h5><p class="mc-designation">Library Information Assistant</p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> TBB </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>bingi92@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596654</span></div><div class="mc-actions"><a href="https://www.linkedin.com/in/kranthikumar16/" target="_blank" title="LinkedIn"><i class="bi bi-linkedin"></i></a></div></article><article class="member-card" data-name="mr. vijay kumar" data-designation="library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/VK.jpg" alt="Mr. Vijay Kumar" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mr. Vijay Kumar </h5><p class="mc-designation">Library Information Assistant</p><p class="mc-section"><i class="bi bi-building"></i> Reader Services Division </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> RSD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>kvijay@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26597017</span></div><div class="mc-actions"><a href="/staff/member/mr-vijay-kumar/profile/" title="View Academic Profile" class="mc-detailed-btn"><i class="bi bi-file-person-fill"></i></a></div></article><article class="member-card" data-name="ms. meemansha nabiyal" data-designation="library information assistant" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/meemansha.jpeg" alt="Ms. Meemansha Nabiyal" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Ms. Meemansha Nabiyal </h5><p class="mc-designation">Library Information Assistant</p><p class="mc-section"><i class="bi bi-building"></i> Text Book, Book Bank &amp; Theses </p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> TBB </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>meemansha@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596654</span></div><div class="mc-actions"><a href="https://www.linkedin.com/in/meemansha-nabiyal28/" target="_blank" title="LinkedIn"><i class="bi bi-linkedin"></i></a></div></article><article class="member-card" data-name="mr. hariom kumar" data-designation="asst. admin. officer" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/Hariom_Kumar.jpeg" alt="Mr. Hariom Kumar" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"><a href="http://internal.iitd.ernet.in/search/ldap1.php?uid=a26896" target="_blank" title="View Mr. Hariom Kumar's profile"> Mr. Hariom Kumar </a></h5><p class="mc-designation">Asst. Admin. Officer</p><p class="mc-section"><i class="bi bi-building"></i> Store &amp; Purchase Section </p></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>a2686@admin.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596665</span></div><div class="mc-actions"><a href="http://internal.iitd.ernet.in/search/ldap1.php?uid=a26896" target="_blank" title="View Profile"><i class="bi bi-box-arrow-up-right"></i></a></div></article><article class="member-card" data-name="mr. govind singh" data-designation="admn. asstt" style="opacity: 1; transform: translateY(0px); transition: opacity 0.4s, transform 0.4s;"><div class="mc-photo"><img src="/media/team/photos/govind.jpg" alt="Mr. Govind Singh" loading="lazy"></div><div class="mc-info"><h5 class="mc-name"> Mr. Govind Singh </h5><p class="mc-designation">Admn. Asstt</p><span class="mc-division-tag"><i class="bi bi-diagram-3-fill"></i> CDD </span></div><div class="mc-actions"><button type="button" class="quick-view-trigger" title="Quick View" aria-label="Quick view" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: var(--gray-200); border-width: medium; border-style: none; border-color: currentcolor; border-image: none; border-radius: 50%; color: var(--gray-600); cursor: pointer; transition: 0.3s;"><i class="bi bi-eye"></i></button><span style="display: flex; gap: 1rem;"><i class="bi bi-envelope-fill"></i>a27197@library.iitd.ac.in</span><span style="display: flex; gap: 1rem;"><i class="bi bi-telephone-fill"></i>26596652</span></div><div class="mc-actions"></div></article></div>

Temp pass will me: Librarian@123, Officer@123 and Staff@123 They can reset by their own.

This is the discussion phase we discuss all the thing before coding